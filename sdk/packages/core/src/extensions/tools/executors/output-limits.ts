...
/**
 * Max combined characters across all entries of one batched tool call.
 * Per-entry caps bound each command/file/query individually, but a single
 * call can batch many entries; past this total, later entries are replaced
 * with placeholders that say how to re-fetch them.
 */
export const MAX_TOOL_CALL_AGGREGATE_OUTPUT_CHARS = 96_000;
